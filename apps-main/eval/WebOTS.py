...
class get_result(object):
    def __init__(self, host):
        ...
        self.Secret = "M2RkODcwNjQwMDZjOTk4MDEyOGRlYWVk"
        # 接口APIKey（到控制台机器翻译服务页面获取）
        self.APIKey = "128fe6d060eae11559f4f66838a90d76"
    ...
    def set_from_language(self, from_language):
        self.BusinessArgs['from'] = from_language

    def set_to_language(self, to_language):
        self.BusinessArgs['to'] = to_language
